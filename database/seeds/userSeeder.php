...
class userSeeder extends Seeder
{
    ...
    public function run()
    {
        $users = [
            ...
            ['name' => 'Roy Joseph Latayan', 'email' => 'registrar1@app.com', 'password' => Hash::make('password'), 'role' => 'registrar', 'gender' => 'Male',],
            ['name' => 'Paul Aedrian Albaytar', 'email' => 'registrar2@app.com', 'password' => Hash::make('password'), 'role' => 'registrar', 'gender' => 'Male',],
