        ...
        <div class="">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="first-slide" src="{{ asset('img/students/Junior high School/jhs 7.jpg') }}"
                                alt="First slide">
                            <div class="container">
                        ...
                        <div class="carousel-item">
                            <img class="second-slide" src="{{ asset('img/students/Junior high School/jhs 11.jpg') }}"
                                alt="Second slide">
                            <div class="container">
                        ...
                        <div class="carousel-item">
                            <img class="third-slide" src="{{ asset('img/students/Junior high School/jhs 14.jpg') }}"
                                alt="Third slide">
                            <div class="container">
            ...
            <div class="row pt-3">
                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                    <img src="{{ asset('img/students/Junior high School/jhs 8.jpg') }}" alt=""
                        class="w-100 shadow-1-strong rounded mb-3">
                    <img src="{{ asset('img/students/Junior high School/jhs 9.jpg') }}" alt=""
                        class="w-100 shadow-1-strong rounded mb-3">
                    <img src="{{ asset('img/students/Junior high School/jhs 10.jpg') }}"
                        alt="" class="w-100 shadow-1-strong rounded mb-3">
                </div>
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <img src="{{ asset('img/students/Junior high School/jhs 15.jpg') }}" alt=""
                        class="w-100 shadow-1-strong rounded mb-3">
                    <img src="{{ asset('img/students/Junior high School/jhs 16.jpg') }}" alt=""
                        class="w-100 shadow-1-strong rounded mb-3">
                    <img src="{{ asset('img/students/Junior high School/jhs 4.jpg') }}" alt=""
                        class="w-100 shadow-1-strong rounded mb-3">
                </div>
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <img src="{{ asset('img/students/Junior high School/jhs 2.jpg') }}" alt=""
                        class="w-100 shadow-1-strong rounded mb-3">
                    <img src="{{ asset('img/students/Junior high School/jhs 3.jpg') }}" alt=""
                        class="w-100 shadow-1-strong rounded mb-3">
                </div>
            </div>
            <!-- Gallery -->
