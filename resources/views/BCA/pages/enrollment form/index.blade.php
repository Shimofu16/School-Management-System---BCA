        ...
        <form action="{{ route('enroll.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="container mb-3">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3 mr-3">
                        <label for="age" class="text-dark h5 font-weight-bold">Age <span
                                class="text-danger">*</span>:</label>
                ...
                <div class="form-row">
                    <div class="col-md-4">
                        <label for="grade_level_id " class="text-dark h5 font-weight-bold">Year Level <span
                                class="text-danger">*</span>:</label>
            ...
            <div class="container mb-3">
                <div class="form-row">
                    <div class="col-md-4 mr-3 mb-3">
                        <label for="guardian_name" class="text-dark h5 font-weight-bold">Full name <span
                            class="text-danger">*</span>:</label>
                ...
                <div class="form-row">
                    <div class="col-md-4 mr-3 mb-3">
                        <label for="guardian_contact" class="text-dark h5 font-weight-bold">Contact No. <span
                            class="text-danger">*</span>:</label>
